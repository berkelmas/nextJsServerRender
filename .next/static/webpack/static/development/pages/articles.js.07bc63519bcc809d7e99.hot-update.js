...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ArticleCards, [{
    ...
    value: function componentDidMount() {
      ...
      articles.on('child_added', function (snapshot) {
        ...
        _this2.setState(function (state) {
          var articles = [article].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(state.articles));
          return {
            articles: articles,
            loading: false
          };
    ...
    value: function render() {
      ...
      }, "Makaleler")), this.state.loading && react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", {
        className: "d-flex justify-content-center p-5"
      }, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_7__["Spinner"], {
        className: "mt-5 ",
        style: {
          width: '6rem',
          height: '6rem'
...
//# sourceMappingURL=articles.js.07bc63519bcc809d7e99.hot-update.js.map